        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-[Secular_One] text-xl text-kingdom-gold">הממלכה של עדי</span>
            </div>
          ...
          {/* Links */}
          <div>
            <h3 className="font-[Secular_One] text-kingdom-gold mb-4">ניווט מהיר</h3>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-[Secular_One] text-kingdom-gold mb-4">צרו קשר</h3>
