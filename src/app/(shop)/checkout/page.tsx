...
export default function CheckoutPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      <h1 className="font-[Secular_One] text-2xl md:text-3xl text-kingdom-charcoal text-center mb-8">
        תשלום מאובטח
      </h1>
      ...
      {step === 1 && (
        <div className="space-y-4">
          <h2 className="font-[Secular_One] text-xl text-kingdom-charcoal mb-4">פרטי הלקוח</h2>
          <div>
      ...
      {step === 2 && (
        <div className="space-y-4">
          <h2 className="font-[Secular_One] text-xl text-kingdom-charcoal mb-4">אופן משלוח</h2>
      ...
      {step === 3 && (
        <div className="space-y-6">
          <h2 className="font-[Secular_One] text-xl text-kingdom-charcoal mb-4">סיכום ותשלום</h2>
